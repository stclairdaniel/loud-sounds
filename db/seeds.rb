...
Track.create!(title: 'Minipops 67 (Source Field Mix)',
              ...
              created_at: Date.parse("#{Faker::Date.between(2.years.ago, Date.today)}").to_s)
Track.create!(title: 'DMX Krew - You Can\'t Hide Your Love (Hidden Love Mix)',
              genre: 'Electronic',
              user_id: 2,
              description: 'A great remix',
              audio_file_url: 'http://res.cloudinary.com/loudsounds/video/upload/v1473293358/2-11_DMX_Krew_-_You_Can_t_Hide_Your_Love_Hidden_Love_Mix_exppt6.mp3',
