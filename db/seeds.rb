...
Track.create!(title: 'Kid for Today',
              genre: 'Chill',
              user_id: 13,
              audio_file_url: 'http://res.cloudinary.com/loudsounds/video/upload/v1473369183/01_Kid_For_Today_oftxgn.m4a',
              image_url: 'http://res.cloudinary.com/loudsounds/image/upload/c_scale,w_250/v1473368936/boards325canada_oiedl6.jpg',
              created_at: Date.parse("#{Faker::Date.between(2.years.ago, Date.today)}").to_s)
